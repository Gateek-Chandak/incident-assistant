...
const IncidentReplayPage = () => {
  ...
  return ( 
    <div className="w-full h-screen flex flex-col">
      {/* Header */}
      <SimulationHeader
        title="Rootly Incident Suggestions Assistant"
      ...
      <div className="flex justify-center mt-60 h-full">
        <h1 className="text-xl font-normal text-black">Click Simulate Incident to start the incident</h1>
      </div>}
